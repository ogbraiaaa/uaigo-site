      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="text-center max-w-3xl mx-auto mb-12">
          ...
          <h2 className="text-3xl sm:text-5xl font-black text-purple-950 tracking-tight">
            Experimente o <span className="text-purple-700">UaiGO!</span> em Ação
          </h2>
          ...
          <div className="lg:col-span-8 bg-white border-2 border-purple-300 rounded-3xl p-4 sm:p-6 shadow-2xl backdrop-blur-xl">
              ...
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-[11px] text-purple-700 flex items-center gap-1 font-bold">
                    ...
                    Você está em: <span className="text-purple-950 font-black">Praça dos Andradas (Barbacena - MG)</span>
                  </p>
                </div>
              </div>
            ...
            <div className="flex flex-wrap items-center gap-2 mb-4">
              <div className="relative flex-1 min-w-[180px]">
                ...
                <input
                  type="text"
                  placeholder="Buscar sarau, Praça dos Andradas, Pontilhão..."
                  value={searchQuery}
            ...
            {activeTab === 'map' && (
              <div className="relative h-[380px] sm:h-[440px] rounded-2xl bg-slate-900 border-2 border-purple-300 overflow-hidden select-none shadow-inner">
                ...
                <div className="absolute top-4 left-4 pointer-events-none text-[10px] uppercase font-black tracking-wider text-purple-200 bg-purple-950/90 px-2.5 py-1 rounded-md border border-purple-600">
                  Barbacena • Região do Pontilhão & São Sebastião
                </div>
                <div className="absolute bottom-4 right-4 pointer-events-none text-[10px] uppercase font-black tracking-wider text-amber-300 bg-slate-950/90 px-2.5 py-1 rounded-md border border-amber-500/40">
                  Circuito das Rosas • Grogotó & Parque Bias Fortes
                </div>
                ...
                <div className="absolute top-4 right-4 z-10 bg-white/95 border border-purple-200 rounded-xl px-3 py-1.5 flex items-center gap-2 shadow-md">
                  ...
                  <span className="text-xs font-black text-purple-950">
                    {filteredEvents.length} eventos em Barbacena no radar
                  </span>
                </div>
              </div>
            )}
              ...
              <div className="p-6 rounded-2xl bg-purple-50 border border-purple-200 space-y-4">
                <div className="flex items-center justify-between border-b border-purple-200 pb-3">
                  <div>
                    <h4 className="text-sm font-black text-purple-950 flex items-center gap-2">
                      ...
                      Circuito Cultural Barbacena • 3 Paradas
                    </h4>
                    <p className="text-xs text-purple-700 font-medium">
                      Tempo estimado: 3h30min • A pé + Linhas Urbanas • 100% Gratuito
                    </p>
                  </div>
                ...
                <div className="space-y-3 relative before:absolute before:left-3 before:top-2 before:bottom-2 before:w-0.5 before:bg-gradient-to-b before:from-purple-600 before:via-amber-500 before:to-emerald-600">
                  <div className="flex items-start gap-4 pl-7 relative">
                    ...
                    <div>
                      <span className="text-[10px] font-black text-purple-700 uppercase">1ª Parada (09:00)</span>
                      <h5 className="text-xs font-black text-purple-950">Feira das Rosas, Artesanato & Flores</h5>
                      <p className="text-[11px] text-purple-800 font-medium">Parque de Exposições Senador Bias Fortes • Doces e flores</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4 pl-7 relative">
                    ...
                    <div>
                      <span className="text-[10px] font-black text-amber-700 uppercase">2ª Parada (16:30)</span>
                      <h5 className="text-xs font-black text-purple-950">Teatro na Antiga Estação Ferroviária: Causos das Vertentes</h5>
                      <p className="text-[11px] text-purple-800 font-medium">Bairro São Sebastião • Espetáculo e memória</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-start gap-4 pl-7 relative">
                    ...
                    <div>
                      ...
                      <h5 className="text-xs font-black text-purple-950">Sarau Poético no Coreto da Praça dos Andradas</h5>
                      <p className="text-[11px] text-purple-800 font-medium">Centro • Poesia ao vivo no Jardim Municipal</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="pt-2 flex items-center justify-between">
                  ...
                  <span className="text-[11px] text-purple-700 font-bold">Inclui mapa de linhas de ônibus de Barbacena</span>
                </div>
              </div>
            )}
            ...
            {activeTab === 'add' && (
              <form onSubmit={handleSimulateAdd} className="p-6 rounded-2xl bg-purple-50 border border-purple-200 space-y-4">
                <div className="border-b border-purple-200 pb-2">
                  ...
                  <p className="text-xs text-purple-700 font-medium">
                    Artistas, coletivos e moradores de Barbacena podem divulgar eventos locais em menos de 1 minuto.
                  </p>
                </div>
                ...
                {addedSuccess ? (
                  <div className="p-4 rounded-xl bg-emerald-100 border border-emerald-400 text-center space-y-1 text-emerald-900 animate-fadeIn">
                    ...
                    <p className="text-xs text-emerald-800 font-medium">O evento já está visível para a comunidade barbacenense no UaiGO!.</p>
                  </div>
                ) : (
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    <div className="space-y-1">
                      ...
                      <input
                        type="text"
                        placeholder="Ex: Roda de Viola no Pontilhão"
                        value={newEventTitle}
                    ...
                    <div className="space-y-1">
                      <label className="text-[11px] font-black text-purple-950">Bairro / Local em Barbacena</label>
                      <input
                        type="text"
                        placeholder="Ex: Praça dos Andradas / Pontilhão"
