        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 pb-12 border-b border-purple-200">
          <div className="md:col-span-5 space-y-3">
            ...
            <p className="text-purple-900/80 leading-relaxed text-xs max-w-sm font-medium">
              Projeto desenvolvido pelo Purple Squad para o <strong className="text-purple-950 font-black">Desafio dos Dados Vivo</strong>. Promovendo a ampliação do acesso à cultura e a descentralização territorial através de dados e colaboração.
            </p>
            ...
            <ul className="space-y-2 text-xs font-semibold text-purple-900/80">
              ...
              <li>
                <a href="#questao-ods" className="hover:text-purple-700 transition-colors">
                  • Questão Norteadora & ODS (4, 8, 10, 11)
                </a>
              </li>
              <li>
              ...
              <li>
                <a href="#midia-diario" className="hover:text-purple-700 transition-colors">
                  • Mídias & Diário de Bordo
                </a>
              </li>
              <li>
          ...
          <div className="md:col-span-4 space-y-2.5">
            ...
            <div className="flex flex-wrap gap-1.5">
              ...
              <span className="px-2.5 py-1 rounded-md bg-red-100 border border-red-300 text-red-950 font-black text-[11px]">
